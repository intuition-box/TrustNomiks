  ...
  return (
    <div
      ...
      className={cn(
        ...
        activeSection !== 'allocation' && 'hidden',
      )}
    ...
    >
      <SectionHeader
        ...
        label="Allocation"
        desc="· Token distribution"
        liveScore={liveAllocationScore}
        maxScore={FACTORY_CLUSTER_MAX.allocation}
        saved={completedSteps.includes(3)}
      />
      {!projectId ? (
        ...
        <div className="px-6 py-6">
          <Form {...step3Form}>
            <form
              onSubmit={step3Form.handleSubmit((data) => onSubmitStep3(data))}
              className="space-y-6"
            >
                ...
                return (
                  ...
                  >
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      ...
                      <span
                        className="tabular inline-flex items-center gap-1.5 text-sm font-semibold"
                    ...
                    <CardContent className="pt-6">
                      ...
                      {fields.length > 1 && (
                        <Button
                          ...
                          onClick={() =>
                            setPendingRemoval({ type: 'allocation', index })
                          }
                        >
                          <X className="h-4 w-4" />
                        </Button>
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormDescription className="text-xs">
                                Auto-calculated from percentage, or edit
                                manually
                              </FormDescription>
                              <FormMessage />
                            </FormItem>
                  ...
                  <SheetHeader>
                    ...
                    <SheetDescription>
                      ...
                      {segmentGuideRowIndex !== null
                        ? ` Applying to segment #${segmentGuideRowIndex + 1}.`
                        : ''}
                    </SheetDescription>
                  </SheetHeader>
