...
- duration_months is the TOTAL time from TGE until the round is fully vested, cliff included. "Unlocks continuously from year 1 to year 3" means duration_months = 36 (it ends 3 years after TGE), with cliff_months = 12; never report only the post-cliff span.
