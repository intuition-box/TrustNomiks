...
import { BLOCKCHAIN_OPTIONS, CATEGORY_OPTIONS, isSectorCompatibleWithCategory } from '@/types/form'
...
/** Section 1: Identity — name, ticker, chain, category/sector (guided), contract, CoinGecko link, TGE date. */
