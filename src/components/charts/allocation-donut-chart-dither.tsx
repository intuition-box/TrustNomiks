...
const SIZES = {
  sm: { box: 160, innerRatio: 42 / 65, supply: 'text-[11px]', caption: 'text-[9px]' },
  lg: { box: 280, innerRatio: 75 / 120, supply: 'text-sm', caption: 'text-[11px]' },
}
...
export function AllocationDonutChartDither({
  ...
  const formattedSupply = maxSupply ? formatCompactNumber(toNumber(maxSupply)) : null
